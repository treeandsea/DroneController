...
class TestDroneStateMapper(TestCase):
    ...
    def test_keyboard_simple_up(self):
        ...
        expected_state = DroneState(rotation, velocity, velocity_ang, acceleration,
                                    acceleration_ang, position)

        position = ZERO_VECTOR
        velocity = ZERO_VECTOR
        acceleration = ZERO_VECTOR
        drone_state = DroneState(rotation, velocity, velocity_ang, acceleration, acceleration_ang,
                                 position)
