...
class QuadroCopterTest(TestCase):
    ...
    def test_calc_simple_up(self):
        ...
        current_state = DroneState(rotation, velocity, velocity_ang, acceleration, acceleration_ang,
                                   position)

        position = UP_VECTOR
        velocity = UP_VECTOR
        acceleration = UP_VECTOR
        future_state = DroneState(rotation, velocity, velocity_ang, acceleration, acceleration_ang,
                                  position)
